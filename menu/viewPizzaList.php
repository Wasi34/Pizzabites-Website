...
<head>
    ...
    <style>
    body {
  background: linear-gradient(to bottom, #ffffff 0%, #0099ff 100%);
}
    .jumbotron {
        padding: 2rem 1rem;
    }
...
<body>
    ...
    <div class="container my-3" id="cont">
        <div class="col-lg-4 text-center bg-blue my-3" style="margin:auto;border-top: 2px groove black;border-bottom: 2px groove black;">     
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                if($loggedin){
                                    $quaSql = "SELECT `itemQuantity` FROM `viewcart` WHERE pizzaId = '$pizzaId'";
                                  ...
                                  echo '<a href="\Codes\Pizzabites\login.php"><button class="btn btn-primary mx-2">Add to Cart</button></a>';
                                }
                            echo '</form>                            
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '" class="mx-2"><button class="btn btn-primary">View Details</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
