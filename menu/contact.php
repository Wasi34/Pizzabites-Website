                  ...
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      ...
                      <?php
                          ...
                          $email = $passRow['email'];
                          $phone = $passRow['phoneNo'];
                          
                      ?>
                      <form action="_manageContactUs.php" method="POST">
                        <div class="row">
                          <div class="col-lg-6">
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/Wasi34" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
