...
if (isset($_POST['name']) && isset($_POST['email'])
	...
	if (empty($name)) {
        ...
        header("Location: signup.php?error=The confirmation password is not matched");
	    exit();
	}
		...
		if (mysqli_num_rows($result) > 0) {
			header("Location: signup.php?error=The email is already registered here, try another.&$user_data");
	        exit();
		}else {
